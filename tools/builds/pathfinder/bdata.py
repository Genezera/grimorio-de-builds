...
PHASES = [
 dict(id="a1", name=L("Nível 1–10", "Level 1–10"), lv=[1, 10], tag=L("Poisonburst Arrow + Contagion", "Poisonburst Arrow + Contagion"),
  ...
  cheap=[L("Arco com dano físico (Transmutation/Augmentation)", "Bow with physical damage (Transmutation/Augmentation)"), L("Botas com Movement Speed", "Boots with Movement Speed")],
  full=[L("Mesmo do barato", "Same as budget")],
 ...
 dict(id="a2", name=L("Nível 11–20", "Level 11–20"), lv=[11, 20], tag=L("Plague Bearer + weapon sets", "Plague Bearer + weapon sets"),
  ...
  cheap=[L("Arco com físico + nível de projéteis", "Bow with physical + projectile levels"), L("Aljava com físico adicionado", "Quiver with added physical")],
  full=[L("Iron Rune no arco com socket", "Iron Rune in a socketed bow")],
 ...
 dict(id="a3", name=L("Nível 21–30", "Level 21–30"), lv=[21, 30], tag=L("Toxic Growth + Gas Arrow", "Toxic Growth + Gas Arrow"),
  ...
  cheap=[L("Arco Dualstring/Recurve com físico", "Dualstring/Recurve bow with physical"), L("Resistências equilibradas", "Balanced resistances")],
 ...
 dict(id="a4", name=L("Nível 31–40", "Level 31–40"), lv=[31, 40], tag=L("Path Seeker + Herald of Plague", "Path Seeker + Herald of Plague"),
  ...
  cheap=[L("Zealot Bow com físico", "Zealot Bow with physical"), L("Toxic Quiver", "Toxic Quiver")],
...
UNIQUES = [
 ...
 U("Snakebite", L("Luvas", "Gloves"), L("Armadura", "Armour"), "start", L("Evasion, Chaos Resistance, regen, chance de veneno e +1 veneno por alvo.", "Evasion, Chaos Resistance, regen, poison chance and +1 poison per target."), L("Pode ser comprada e usada cedo.", "Can be bought and used early."), L("Luvas de ES/Evasion com resistências.", "ES/Evasion gloves with resistances.")),
...
GEAR = [
 dict(slot=L("Arco (1–57)", "Bow (1–57)"), cheap=L("Físico adicionado + % físico", "Added physical + % physical"), value=L("+ nível de projéteis + attack speed", "+ projectile levels + attack speed"), full=L("Artillery Bow com físico alto", "Artillery Bow with high physical"), affix=L("% físico; físico adicionado; + projéteis", "% physical; added physical; + projectiles"), note=L("Elemental no arco não aumenta o veneno.", "Elemental on the bow doesn't raise poison.")),
 ...
 dict(slot=L("Capacete", "Helmet"), cheap=L("ES/Evasion + resists", "ES/Evasion + resists"), value="Sorcerous Tiara", full=L("Ancestral Tiara com + curses/minions", "Ancestral Tiara with + curses/minions"), affix=L("ES; resist", "ES; resist"), note=""),
 ...
 dict(slot=L("Luvas", "Gloves"), cheap="Snakebite", value="Snakebite", full=L("Luvas com mods de Transcendent Limbs (magnitude de ailment/curse)", "Gloves with Transcendent Limbs mods (ailment/curse magnitude)"), affix=L("Veneno; resist", "Poison; resist"), note=""),
 dict(slot=L("Botas", "Boots"), cheap="Corpsewade", value=L("Corpsewade com 3+ sockets", "Corpsewade with 3+ sockets"), full=L("Corpsewade Runeforged + corrompida (5 sockets)", "Runeforged + corrupted Corpsewade (5 sockets)"), affix=L("Nível da bota = nível do Decompose", "Boots level = Decompose level"), note=L("Obrigatória no 58.", "Mandatory at 58.")),
 dict(slot=L("Amuleto", "Amulet"), cheap="Solar Amulet", value="Astramentis", full=L("Fracturado com +3 minions ou 45+ Spirit", "Fractured with +3 minions or 45+ Spirit"), affix=L("Spirit; + minions", "Spirit; + minions"), note=""),

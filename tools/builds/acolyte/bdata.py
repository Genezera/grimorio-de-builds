...
MECH = dict(
 ...
 sections=[
  ...
  dict(type="table", h=L("Itens por nível: o que equipar e quando", "Items by level: what to equip and when"),
       p=L("Uniques baratas (quase todas abaixo de 1 Exalted) e o que procurar nos rares no meio do caminho. Nenhuma faixa fica sem upgrade.",
           "Cheap uniques (nearly all under 1 Exalted) and what to look for on rares in between. No level range is left without an upgrade."),
       cols=[L("Nível", "Level"), L("Peça", "Piece"), L("O que ganha", "What it gives")], rows=[
   ["1", "Plaguefinger", L("Chance de envenenar e TODO o dano do hit somando no veneno", "Poison chance and ALL hit damage adding to poison")],
   ["1", L("Luminous Pace · Meginord's Girdle · Asphyxia's Wrath", "Luminous Pace · Meginord's Girdle · Asphyxia's Wrath"), L("Movimento, Força para equipar e dano plano na aljava", "Movement, Strength to equip gear and flat quiver damage")],
   ["8", "Surefooted Sigil · Blackheart", L("Vida, dodge maior, caos plano e regen", "Life, longer dodge, flat chaos and regen")],
   ["10", "Goldrim", L("Resistências resolvidas sozinho até ~40", "Resistances solved by itself until ~40")],
   ["11", "Wanderlust", L("20% Movement Speed e imune a Slow", "20% Movement Speed and slow immunity")],
   ["14", L("Toxic Growth (gem)", "Toxic Growth (gem)"), L("Dano de boss: pústulas com Concentrated Area", "Boss damage: pustules with Concentrated Area")],
   ["16", "Splinterheart · The Lethal Draw", L("Projéteis se dividem e vida por acerto", "Projectiles split and life per hit")],
   ["16", "Ghostmarch", L("Dodge Roll atravessa inimigos, Evasão/ES e caos", "Dodge Roll passes through enemies, Evasion/ES and chaos")],
   ["28", "Atsak's Sight · Death's Harp", L("Crítico que envenena e flecha adicional", "Crit that poisons and an additional arrow")],
   ["33", "Snakebite", L("+1 veneno simultâneo no alvo", "+1 simultaneous poison on the target")],
   ["36", "Icefang Orbit · Quatl's Molt", L("+15–25% magnitude do veneno; peito com vida, caos e Deflection", "+15–25% poison magnitude; chest with life, chaos and Deflection")],
   ["39", "Slivertongue", L("Fork e Pierce no próprio arco: clear de mapa antes dos mapas", "Fork and Pierce on the bow itself: map-level clear before maps")],
   ["40", L("Runeforge na Verisium Anvil", "Runeforge at the Verisium Anvil"), L("Splinterheart/Slivertongue com Medved's Crest of the Circle", "Splinterheart/Slivertongue with Medved's Crest of the Circle")],
   ["45+", L("Rares: Spirit no peito e amuleto", "Rares: Spirit on chest and amulet"), L("Blasphemy, Herald of Plague e Wind Dancer ligados", "Blasphemy, Herald of Plague and Wind Dancer running")],
   ["65", L("Talisman no Set 2 · aljava com físico + raio", "Talisman on Set 2 · quiver with physical + lightning"), L("Snapshot dos Remnants e dano plano para a Repulsion", "Remnant snapshot and flat damage for Repulsion")],
   ["72+", L("Obliterator Bow + runas", "Obliterator Bow + runes"), L("Countess Seske's Rune of Archery e Idol of Thruldana", "Countess Seske's Rune of Archery and Idol of Thruldana")],
  ]),

...
GEAR = [
 ...
 dict(slot=L("Aljava", "Quiver"), cheap=L("Toxic Quiver com dano plano", "Toxic Quiver with flat damage"), value="Primed Quiver", full=L("Primed Quiver: físico + raio + bow damage + crítico", "Primed Quiver: physical + lightning + bow damage + crit"), affix=L("Dano plano; attack speed", "Flat damage; attack speed"), lvls=[dict(lv=1, n="Asphyxia's Wrath"), dict(lv=8, n="Blackgleam"), dict(lv=16, n="The Lethal Draw"), dict(lv=45, n=L("Rare: físico + raio planos", "Rare: flat physical + lightning")), dict(lv=75, n="Primed Quiver")], note=""),
 ...
 dict(slot=L("Capacete", "Helmet"), cheap=L("Vida + resist", "Life + resist"), value=L("ES pura (Subterfuge Mask)", "Pure ES (Subterfuge Mask)"), full=L("ES + crítico + Cyclonic Alloy", "ES + crit + Cyclonic Alloy"), affix=L("% ES; crítico", "% ES; crit"), lvls=[dict(lv=10, n="Goldrim"), dict(lv=28, n="Atsak's Sight"), dict(lv=65, n=L("Rare de ES pura (Subterfuge Mask)", "Pure ES rare (Subterfuge Mask)"))], note="Rune of Reach"),
 dict(slot="Body Armour", cheap=L("Evasão/ES", "Evasion/ES"), value=L("Evasão alta + Spirit", "High Evasion + Spirit"), full=L("Evasão + Spirit 55+ + Chaos Resistance", "Evasion + 55+ Spirit + Chaos Resistance"), affix=L("Spirit; % Evasão; Deflection", "Spirit; % Evasion; Deflection"), lvls=[dict(lv=1, n=L("Peito de Evasão com vida", "Evasion chest with life")), dict(lv=36, n="Quatl's Molt"), dict(lv=45, n=L("Rare: Evasão + Spirit", "Rare: Evasion + Spirit"))], note="Craiceann's Rune of Warding"),
 dict(slot=L("Luvas", "Gloves"), cheap=L("Dano plano", "Flat damage"), value=L("Físico + raio plano", "Flat physical + lightning"), full=L("Físico + raio + attack speed ('Marksman': + projéteis)", "Physical + lightning + attack speed ('Marksman': + projectiles)"), affix=L("Dano plano; attack speed", "Flat damage; attack speed"), lvls=[dict(lv=1, n="Plaguefinger"), dict(lv=33, n="Snakebite"), dict(lv=65, n=L("Rare: físico + raio + attack speed", "Rare: physical + lightning + attack speed"))], note=""),
 dict(slot=L("Botas", "Boots"), cheap=L("Movement Speed", "Movement Speed"), value=L("30% MS + Evasão/ES", "30% MS + Evasion/ES"), full=L("30% MS + Deflection", "30% MS + Deflection"), affix=L("MS; ES; resist", "MS; ES; resist"), lvls=[dict(lv=1, n="Luminous Pace"), dict(lv=11, n="Wanderlust"), dict(lv=16, n="Ghostmarch"), dict(lv=60, n=L("Rare: 30% MS + Evasão/ES", "Rare: 30% MS + Evasion/ES"))], note="Farrul's Rune of the Chase"),
 ...
 dict(slot=L("Anéis", "Rings"), cheap="Blackheart", value=L("Físico plano + resist", "Flat physical + resist"), full=L("Físico plano + remnant effect (Liege)", "Flat physical + remnant effect (Liege)"), affix=L("Dano plano; remnant effect; resist", "Flat damage; remnant effect; resist"), lvls=[dict(lv=1, n="Blackheart"), dict(lv=36, n="Icefang Orbit"), dict(lv=60, n=L("Rare: físico plano + resist", "Rare: flat physical + resist"))], note=""),
 dict(slot=L("Cinto", "Belt"), cheap=L("Vida + resist", "Life + resist"), value=L("Vida + resist + charm slots", "Life + resist + charm slots"), full="Mageblood · Headhunter", affix=L("Vida; resist", "Life; resist"), lvls=[dict(lv=1, n="Meginord's Girdle"), dict(lv=45, n=L("Rare: vida + resistências", "Rare: life + resistances")), dict(lv=90, n="Mageblood")], note=""),
 dict(slot="Charms", cheap="Thawing · Silver · Ruby", value="Nascent Hope · Ngamahu's Chosen", full="Rite of Passage · The Fall of the Axe", affix="", lvls=[dict(lv=12, n="Nascent Hope"), dict(lv=18, n="Sanguis Heroum"), dict(lv=65, n="Ngamahu's Chosen"), dict(lv=90, n="Rite of Passage")], note=""),
]
BUY_ORDER = [

...
GEAR = [
 ...
 dict(slot=L("Botas", "Boots"), cheap=L("30% MS + Deflection", "30% MS + Deflection"), value=L("35% MS + Evasão + resist", "35% MS + Evasion + resist"), full=L("Drakeskin Boots 35% MS + Deflection", "35% MS Drakeskin Boots + Deflection"), affix=L("MS; Evasão; Deflection; resist", "MS; Evasion; Deflection; resist"), lvls=[dict(lv=1, n="Luminous Pace"), dict(lv=11, n="Wanderlust"), dict(lv=16, n="Gamblesprint"), dict(lv=60, n=L("Rare: 30–35% MS", "Rare: 30–35% MS"))], note=L("Farrul's Rune of the Chase na tatuagem.", "Farrul's Rune of the Chase as a tattoo.")),
 ...
 dict(slot=L("Cinto", "Belt"), cheap=L("Utility Belt com vida", "Utility Belt with life"), value="Ingenuity", full="Headhunter", affix=L("Vida; charm slots", "Life; charm slots"), lvls=[dict(lv=1, n=L("Cinto com vida", "Belt with life")), dict(lv=75, n="Ingenuity"), dict(lv=93, n="Headhunter")], note=""),
 dict(slot="Charms / Flasks", cheap="Thawing · Stone · Golden", value="Breath of the Mountains · Nascent Hope · Lavianga's Spirits", full="Rite of Passage", affix="", lvls=[dict(lv=5, n="Breath of the Mountains"), dict(lv=12, n="Nascent Hope"), dict(lv=85, n="Lavianga's Spirits"), dict(lv=93, n="Rite of Passage")], note=""),
]
BUY_ORDER = [

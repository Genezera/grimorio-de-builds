...
PHASES = [
 dict(id="a1", name=L("Ato 1", "Act 1"), lv=[1, 15], tag=L("Frozen Locus + Glacial Cascade", "Frozen Locus + Glacial Cascade"),
  ...
  cheap=[L("Quarterstaff Magic com mais DPS (até o nível 13)", "Magic quarterstaff with the most DPS (until level 13)"), L("Botas com 10%+ Movement Speed", "Boots with 10%+ Movement Speed"), "Luminous Pace"],
  full=[L("Luvas com + nível de skills melee e dano elemental plano", "Gloves with + melee skill levels and flat elemental damage"), L("Changeling Talisman no Set 2 (Pounce)", "Changeling Talisman on Set 2 (Pounce)")],
 ...
 dict(id="a2", name=L("Ato 2", "Act 2"), lv=[16, 31], tag=L("Storm Wave + Freeze de boss", "Storm Wave + boss Freeze"),
  ...
  cheap=[L("Anéis com dano elemental plano e resistência", "Rings with flat elemental damage and resistance"), "Horns of Bynden"],
  full=[L("Amuleto com + nível de skills melee", "Amulet with + melee skill levels"), L("Botas 20% Movement Speed", "20% Movement Speed boots")],
 ...
 dict(id="a3", name=L("Ato 3", "Act 3"), lv=[32, 45], tag=L("Herald of Thunder + sinos do Hollow Focus", "Herald of Thunder + Hollow Focus bells"),
  ...
  cheap=[L("Luvas +1/+2 nível de melee + dano plano", "Gloves +1/+2 melee levels + flat damage"), L("Peito e capacete de Evasão/ES com vida", "Evasion/ES chest and helmet with life")],
  full=[L("Iron Rune ×2 no peito; Storm/Glacial Rune nas botas/capacete", "Iron Rune ×2 on the chest; Storm/Glacial Rune on boots/helmet")],
 ...
 dict(id="a4", name=L("Ato 4 + Interlúdios", "Act 4 + Interludes"), lv=[46, 64], tag=L("Fim da campanha + preparar a troca", "End of campaign + prepare the swap"),
  ...
  cheap=[L("Resistências no cap para os mapas", "Capped resistances for maps"), L("Botas 25–30% Movement Speed", "25–30% Movement Speed boots")],
  full=[L("Talisman rare com dano elemental plano guardado para a troca", "Rare Talisman with flat elemental damage saved for the swap"), L("Greater Jeweller's Orb guardado", "Greater Jeweller's Orb saved")],
...
MILESTONES = {
 ...
 13: L("Hollow Palm Technique: mãos vazias.", "Hollow Palm Technique: empty hands."),
...
UNIQUES = [
 U("Luminous Pace", L("Botas", "Boots"), L("Armadura", "Armour"), "a1", L("10% Movement Speed, ES e recarga de ES mais cedo.", "10% Movement Speed, ES and faster ES recharge start."), L("Bota barata do começo (sugestão do havoc616 para trade).", "Cheap early boots (havoc616's trade suggestion)."), L("Botas com Movement Speed.", "Boots with Movement Speed.")),
 U("Horns of Bynden", L("Capacete", "Helmet"), L("Armadura", "Armour"), "a2", L("Força, Rage ao acertar melee e Armour por Rage.", "Strength, Rage on melee hit and Armour per Rage."), L("Capacete barato da campanha.", "Cheap campaign helmet."), L("Capacete com vida.", "Helmet with life.")),
 U("Breath of the Mountains", "Charm", "Charm", "swap", L("Dá uma Power Charge ao usar.", "Grants a Power Charge on use."), L("Carga extra barata na troca.", "Cheap extra charge at the swap."), "Sapphire Charm"),
...
GEAR = [
 dict(slot="Talisman", cheap=L("Spiny Talisman 300+ EDPS", "300+ EDPS Spiny Talisman"), value=L("380+ EDPS com + níveis", "380+ EDPS with + levels"), full=L("490+ EDPS, 15%+ crítico, + níveis, attack speed", "490+ EDPS, 15%+ crit, + levels, attack speed"), affix=L("Fogo/frio/raio plano; % elemental com ataques; crítico; +3 ataques (Perfect Essence of Battle)", "Flat fire/cold/lightning; % elemental attack damage; crit; +3 attacks (Perfect Essence of Battle)"), note=TALISMAN_RUNES),
 dict(slot=L("Luvas (Fists of Stone)", "Gloves (Fists of Stone)"), cheap=L("Luvas com dano plano (viram Fists of Stone)", "Gloves with flat damage (become Fists of Stone)"), value=L("Dano crítico + attack speed", "Crit damage + attack speed"), full=L("Dano crítico, attack speed e Power Charge no crítico", "Crit damage, attack speed and Power Charge on crit"), affix=L("Dano crítico → crítico base; attack speed → Onslaught; dano plano → dano extra; defesa → more Evasão/ES", "Crit damage → base crit; attack speed → Onslaught; flat damage → extra damage; defence → more Evasion/ES"), note=L("Runeforge na Verisium Anvil para a Refutation.", "Runeforge at the Verisium Anvil for Refutation.")),
 dict(slot=L("Amuleto", "Amulet"), cheap=L("+2 projéteis + vida", "+2 projectiles + life"), value=L("+50 Spirit + Thaumaturgic Generator", "+50 Spirit + Thaumaturgic Generator"), full=L("Absent Amulet: Spirit, +3 projéteis, instill", "Absent Amulet: Spirit, +3 projectiles, instill"), affix=L("Spirit; + projéteis; crítico; ES", "Spirit; + projectiles; crit; ES"), note=L("Instill: Thaumaturgic Generator (ou Zarokh's Gift no Aspirational).", "Instill: Thaumaturgic Generator (or Zarokh's Gift in Aspirational).")),
 dict(slot=L("Capacete", "Helmet"), cheap=L("ES + vida", "ES + life"), value="Myris Uxor · Alpha's Howl", full=L("Ancestral Tiara: ES alto + Raven-Touched Shard", "Ancestral Tiara: high ES + Raven-Touched Shard"), affix=L("% ES; ES plano; vida", "% ES; flat ES; life"), note=L("Instill Thaumaturgic Generator no capacete quando o amuleto usar Zarokh's Gift.", "Thaumaturgic Generator instill on the helmet once the amulet uses Zarokh's Gift.")),
 dict(slot="Body Armour", cheap=L("Evasão/ES (Torment Jacket)", "Evasion/ES (Torment Jacket)"), value="Forgotten Warden", full=L("Forgotten Warden bem rolado · Sleek Jacket +50 Spirit (mapa)", "Well-rolled Forgotten Warden · +50 Spirit Sleek Jacket (mapping)"), affix=L("% Evasão/ES; Spirit", "% Evasion/ES; Spirit"), note=L("Greater Iron Rune ×2 · Rune of Foundations.", "Greater Iron Rune ×2 · Rune of Foundations.")),
 dict(slot=L("Botas", "Boots"), cheap=L("30% MS + Deflection", "30% MS + Deflection"), value=L("35% MS + Evasão + resist", "35% MS + Evasion + resist"), full=L("Drakeskin Boots 35% MS + Deflection", "35% MS Drakeskin Boots + Deflection"), affix=L("MS; Evasão; Deflection; resist", "MS; Evasion; Deflection; resist"), note=L("Farrul's Rune of the Chase na tatuagem.", "Farrul's Rune of the Chase as a tattoo.")),
 dict(slot=L("Anéis", "Rings"), cheap=L("Prismatic Ring: dano de frio/raio plano + resist", "Prismatic Ring: flat cold/lightning + resist"), value=L("Gold Ring: dano plano + raridade", "Gold Ring: flat damage + rarity"), full=L("Físico + raio plano + raridade · Kalandra's Touch", "Flat physical + lightning + rarity · Kalandra's Touch"), affix=L("Dano plano em ataques; raridade; resist", "Flat attack damage; rarity; resist"), note=""),
 dict(slot=L("Cinto", "Belt"), cheap=L("Utility Belt com vida", "Utility Belt with life"), value="Ingenuity", full="Headhunter", affix=L("Vida; charm slots", "Life; charm slots"), note=""),
 dict(slot="Charms / Flasks", cheap="Thawing · Stone · Golden", value="Breath of the Mountains · Nascent Hope · Lavianga's Spirits", full="Rite of Passage", affix="", note=""),
]
BUY_ORDER = [
 dict(p=1, item=L("Spiny Talisman 300+ EDPS", "300+ EDPS Spiny Talisman"), phase="65", cost=L("Valor", "Value"), impact=L("Libera a troca", "Unlocks the swap")),
 dict(p=2, item=L("Amuleto +50 Spirit", "+50 Spirit amulet"), phase="75", cost=L("Valor", "Value"), impact=L("Cast on Critical (teleporte)", "Cast on Critical (teleport)")),
 dict(p=3, item="Forgotten Warden", phase="77", cost=L("Barato", "Cheap"), impact=L("Sobrevivência", "Survival")),
 dict(p=4, item=L("Thaumaturgic Generator (instill)", "Thaumaturgic Generator (instill)"), phase="77", cost=L("Valor", "Value"), impact="Power Charges"),
 dict(p=5, item=L("Time-Lost Jewel de crítico", "Crit Time-Lost Jewel"), phase="77", cost=L("Valor", "Value"), impact=L("Crítico → mais teleporte", "Crit → more teleport")),
 dict(p=6, item=L("Luvas com dano crítico + Power Charge no crítico", "Gloves with crit damage + Power Charge on crit"), phase="85", cost=L("Luxo", "Luxury"), impact=L("Cargas automáticas", "Automatic charges")),
 dict(p=7, item="Rakiata's Flow · Headhunter", phase="93", cost=L("Luxo", "Luxury"), impact="Min-max"),
]

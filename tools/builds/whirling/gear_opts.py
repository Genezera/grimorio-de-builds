...
GEAR_OPTS = {
 ...
 "spear": [
  O(L("Spear branca do vendor (Hardwood Spear)", "White vendor spear (Hardwood Spear)"), "r", 1, 25, ("Só para a Whirling Slash funcionar: dano físico baixo. Vale até o nível 15.", "Just so Whirling Slash works: low physical damage. Good until level 15.")),
  O("Skysliver", "u", 16, 82, ("Winged Spear (nível 16): dano de raio, +15–30% de velocidade de ataque e chance de Shock. Sua spear do 16 ao ~40.", "Winged Spear (level 16): lightning damage, +15–30% attack speed and Shock chance. Your spear from 16 to ~40.")),
  O(L("Spear rare com dano elemental e velocidade", "Rare spear with elemental damage and speed"), "r", 16, 66, ("Alternativa à Skysliver se você tiver uma rare com dano elemental adicionado e velocidade de ataque.", "An alternative to Skysliver if you have a rare with added elemental damage and attack speed.")),
  O(L("Skysliver Runeforged", "Runeforged Skysliver"), "u", 40, 90, ("A mesma Skysliver na base Runeforged: mais slots para Soul Cores de velocidade (nível 40).", "The same Skysliver on the Runeforged base: more slots for speed Soul Cores (level 40)."), cost="cheap"),
  O("Rune Edge", "u", 60, 97, ("A spear do PoB final do autor: Thrud's Might e Soul Cores de Quipolatl, mais velocidade de mods explícitos.", "The author's final PoB spear: Thrud's Might and Quipolatl Soul Cores, plus more explicit-mod speed."), cost="lux"),
 ],
 "helmet": [
  ...
  O(L("Imperial Greathelm rare ilvl 82", "Rare Imperial Greathelm ilvl 82"), "r", 80, 90, ("A base do autor no endgame (nível 80): vida, Armour e resistência a frio.", "The author's endgame base (level 80): life, Armour and cold resistance."), cost="value"),
  O("Mind Salvation", "u", 80, 96, ("O capacete do PoB final do autor (luxo): Armour alta e Armour aplicada a dano elemental. Confira o requisito no jogo.", "The helmet of the author's final PoB (luxury): high Armour and Armour applied to elemental damage. Check the requirement in game."), cost="lux"),
 ],
 "body": [
 ...
 "gloves": [
  ...
  O(L("Massive Mitts rare ilvl 82", "Rare Massive Mitts ilvl 82"), "r", 80, 90, ("A base do autor no endgame (nível 80), com Rune of Warping.", "The author's endgame base (level 80), with a Rune of Warping."), cost="value"),
  O("Dire Caress", "u", 80, 96, ("As luvas do PoB final do autor (luxo): Armour, vida e resistência a caos. Confira o requisito no jogo.", "The gloves of the author's final PoB (luxury): Armour, life and chaos resistance. Check the requirement in game."), cost="lux"),
 ],
 "boots": [
  ...
  O(L("Vaal Greaves rare ilvl 82 com 35% de movimento", "Rare Vaal Greaves ilvl 82 with 35% movement"), "r", 75, 92, ("A base do autor (nível 75): 35% de movimento (só ilvl 82), vida e resistências. Aba Crafting.", "The author's base (level 75): 35% movement (only at ilvl 82), life and resistances. Crafting tab."), cost="value"),
  O("Armageddon Tread", "u", 75, 96, ("As botas do PoB final do autor (luxo): 30% de movimento, vida, mana e 3 Perfect Body Runes. Confira o requisito no jogo.", "The boots of the author's final PoB (luxury): 30% movement, life, mana and 3 Perfect Body Runes. Check the requirement in game."), cost="lux"),
 ],
 "amulet": [
  ...
  O("Viper Heart", "u", 70, 98, ("O amuleto do PoB final do autor (luxo): concede a Trinity (100 Spirit). Confira o requisito no jogo.", "The amulet of the author's final PoB (luxury): grants Trinity (100 Spirit). Check the requirement in game."), cost="lux"),
 ],
 "rings": [
  ...
  O("Miracle Gyre + Morbid Knuckle", "u", 60, 96, ("Os anéis do PoB final do autor (luxo): dano adicionado, vida e resistências. Confira preço e requisito.", "The rings of the author's final PoB (luxury): added damage, life and resistances. Check price and requirement."), cost="lux"),
 ],
 "belt": [
  ...
  O("Headhunter", "u", 50, 98, ("O cinto da variante Early do autor (luxo, ~246 Divines): os mods dos Rares que você mata.", "The belt of the author's Early variant (luxury, ~246 Divines): the mods of the Rares you kill.")),
...
SLOT_OPTS = ["crossbow", "spear", "helmet", "body", "gloves", "boots", "amulet", "rings", "belt", "charms", "flasks"]

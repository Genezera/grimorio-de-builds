...
TXT = {
 ...
 "en": dict(TITLE="Frost Cyclone", DESC="Interactive Mercenary Gemling Whirling Glacial Bolt guide (ice crossbow, level 1 to 100, the same build through the whole campaign) — PoE 2 Forbidden Rites",
            ...
            LEAD="The final build is already the level 1 build: the spear spins and breaks the ice, the crossbow freezes and plants the crystal walls. Tell it your level and what you already have, and the guide shows what to do now, gem by gem, item by item, up to the endgame Whirling Glacial Bolt (one tree respec at 79)."),
}
...
PHASES = [
 dict(id="a1", name=L("Ato 1", "Act 1"), lv=[1, 15], tag=L("Whirling Slash + Permafrost Bolts", "Whirling Slash + Permafrost Bolts"),
  ...
  goal=L("A build do endgame começa no nível 1: Set 1 = spear branca do vendor com Whirling Slash; Set 2 = Rampart Raptor (Tense Crossbow, sem requisito de nível, quase de graça) com Permafrost Bolts e uma Lesser Glacial Rune. A Permafrost (besta) faz o dano e congela o pack de longe; a Whirling Slash (spear, troque de set no botão de movimento) é para se reposicionar e para o que chegar perto: ela Desacelera, Cega e empurra. Fragmentation Rounds fica no Set 2 para estilhaçar o boss congelado. Depois do King in the Mists (~10, +30 Spirit) entra o Herald of Ice (nível 12): cada inimigo congelado que morre explode em gelo. Na árvore você segue a de leveling do autor, com dano de projétil primeiro (Remorseless e Ricochet). O dano vem da BESTA; a spear só serve para você se mover e limpar o que sobrar.",
         "The endgame build starts at level 1: Set 1 = a white vendor spear with Whirling Slash; Set 2 = the Rampart Raptor (Tense Crossbow, no level requirement, nearly free) with Permafrost Bolts and a Lesser Glacial Rune. Permafrost (crossbow) does the damage and freezes the pack from range; Whirling Slash (spear, swap sets on the movement button) is for repositioning and for whatever gets close: it Slows, Blinds and knocks back. Fragmentation Rounds stays on Set 2 to shatter the frozen boss. After King in the Mists (~10, +30 Spirit) Herald of Ice comes in (level 12): every frozen enemy that dies explodes into ice. On the tree you follow the author's leveling tree, projectile damage first (Remorseless and Ricochet). The damage comes from the CROSSBOW; the spear is just for moving and cleaning up what's left."),
  rotation=[L("Permafrost Bolts (Set 2) no pack até congelar", "Permafrost Bolts (Set 2) into the pack until frozen"), L("Set 1: Whirling Slash só para se mover ou afastar o que chegar perto", "Set 1: Whirling Slash only to move or push away what gets close"), L("Boss congelado: Fragmentation Rounds (estilhaços)", "Frozen boss: Fragmentation Rounds (shrapnel)")],
  gems=[
  ...
  tree=L("A árvore de LEVELING do autor, dano primeiro: Remorseless e Ricochet (+15% de dano de projétil cada), depois Blur (movimento). Nos primeiros 17 pontos são +30% de dano de projétil que o Glacial Bolt e a Permafrost usam; a árvore do endgame tem 0%.", "The author's LEVELING tree, damage first: Remorseless and Ricochet (+15% projectile damage each), then Blur (movement). In the first 17 points that's +30% projectile damage that Glacial Bolt and Permafrost use; the endgame tree has 0%."),
 ...
 dict(id="a2", name=L("Ato 2", "Act 2"), lv=[16, 31], tag=L("Skysliver e Glacial Bolt", "Skysliver and Glacial Bolt"),
  ...
  gems=[
   ...
   G("Freezing Mark", ["Eternal Mark"], L("Boss", "Boss"), L("Marca o boss: quando ele Congela você ganha dano de frio extra. Uncut nível 7 (~24). Marque antes de atirar.", "Marks the boss: when it Freezes you gain extra cold damage. Level 7 Uncut (~24). Mark before shooting."), "free", since=24),
  ...
  tree=L("Pontos 18–34: Heavy Ammunition (+40% de dano de projétil), Careful Aim (+20%), Adrenaline Rush (velocidade ao matar) e Combat Alchemy (flasks). Os primeiros 2 pontos de Weapon Set entram em cada set (quando o mapa deixa).", "Points 18–34: Heavy Ammunition (+40% projectile damage), Careful Aim (+20%), Adrenaline Rush (speed on kill) and Combat Alchemy (flasks). The first 2 Weapon Set points go into each set (where the map allows)."),
 ...
 dict(id="a3", name=L("Ato 3", "Act 3"), lv=[32, 45], tag=L("War Banner e armas forjadas", "War Banner and runeforged weapons"),
  ...
  gems=[
   ...
   G("Freezing Mark", ["Mark for Death II", "Mark of Siphoning II", "Charged Mark", "Eternal Mark"], L("Boss", "Boss"), L("Marca o boss: dano de frio extra quando ele Congela; o Mark dura, dá mana e deixa o chão Shocked. Marque antes de atirar.", "Marks the boss: extra cold damage when it Freezes; the Mark lasts, gives mana and leaves the ground Shocked. Mark before shooting."), "free", since=24),
  ...
  tree=L("Pontos 35–50: Honed Instincts (+8% velocidade de ataque e de projétil), Vile Wounds (+33% de dano contra alvos com ailment: o Freeze conta), Clean Shot (+15%), Colossal Weapon (área) e Overwhelm (+40% de dano com arma de duas mãos: a besta).", "Points 35–50: Honed Instincts (+8% attack and projectile speed), Vile Wounds (+33% damage against ailed targets: Freeze counts), Clean Shot (+15%), Colossal Weapon (area) and Overwhelm (+40% damage with two-handed weapons: the crossbow)."),
 ...
 dict(id="a4", name=L("Ato 4 e Interlúdios", "Act 4 and Interludes"), lv=[46, 64], tag=L("Runemastered e Scavenged Plating", "Runemastered and Scavenged Plating"),
  ...
  tree=L("Pontos 51–72: Rapid Reload (+40% de recarga: compensa a Rampart Raptor), Crystal Elixir (+40% de dano elemental com flask), Short Shot (+20% de dano de projétil), Emboldened Avatar (+25% de Freeze buildup) e Forces of Nature (penetração elemental).", "Points 51–72: Rapid Reload (+40% reload: offsets the Rampart Raptor), Crystal Elixir (+40% elemental damage during a flask), Short Shot (+20% projectile damage), Emboldened Avatar (+25% Freeze buildup) and Forces of Nature (elemental penetration)."),
 ...
 dict(id="maps", name=L("Mapas 65+", "Maps 65+"), lv=[65, 78], tag=L("Árvore completa e Morior Invictus", "Full tree and Morior Invictus"),
  carry=L("Você: Whirling Slash (Set 1) + Glacial Bolt (Set 2)", "You: Whirling Slash (Set 1) + Glacial Bolt (Set 2)"), dmgSplit=[100, 0],
  goal=L("Aqui a árvore de leveling fecha os 87 pontos (Spray and Pray, Pressure Points, Acceleration). Rapid Attacks III sobe no Glacial Bolt. O trabalho agora é juntar dinheiro para o Morior Invictus (nível 65, ~6 Divines) e a Desolate Crossbow: com eles você faz o respec do 79 para a árvore do endgame (Iron Reflexes, Armour) e troca Herald e Banner pelas reservas do autor (Arctic Armour, Verisium, Berserk). 4º Trial (~75): Motoric Implants (+2 níveis nas skills de Dex).",
         "Here the leveling tree closes its 87 points (Spray and Pray, Pressure Points, Acceleration). Rapid Attacks III goes on Glacial Bolt. The job now is saving for Morior Invictus (level 65, ~6 Divines) and the Desolate Crossbow: with them you respec at 79 into the endgame tree (Iron Reflexes, Armour) and swap Herald and Banner for the author's reservations (Arctic Armour, Verisium, Berserk). 4th Trial (~75): Motoric Implants (+2 levels on Dex skills)."),
  ...
  gems=[
   ...
   G("Freezing Mark", ["Mark for Death II", "Mark of Siphoning II", "Charged Mark", "Eternal Mark"], L("Boss", "Boss"), L("Marca o boss: dano de frio extra quando ele Congela; o Mark dura, dá mana e deixa o chão Shocked. Marque antes de atirar.", "Marks the boss: extra cold damage when it Freezes; the Mark lasts, gives mana and leaves the ground Shocked. Mark before shooting."), "free", since=24),
   G("Herald of Ice", ["Magnified Area II", "Elemental Focus"], L("Explosão de gelo", "Ice explosion"), L("30 Spirit. Sai quando você tiver Spirit para as reservas do endgame.", "30 Spirit. Leaves once you have Spirit for the endgame reservations."), "core", 1, SP30),
   G("War Banner", ["Expanse", "Prolonged Duration II"], L("Buff de ataque", "Attack buff"), L("30 Spirit. Sai quando você tiver Spirit para as reservas do endgame.", "30 Spirit. Leaves once you have Spirit for the endgame reservations."), "core", 2, SP30),
  ...
  tree=L("Pontos 73–87 fecham a árvore de leveling: Spray and Pray (+50% de dano de ataque andando), Run and Gun, Pressure Points (+35% de Freeze buildup) e Acceleration. No 79 você faz o respec para a árvore do Endgame (Early).", "Points 73–87 close the leveling tree: Spray and Pray (+50% attack damage while moving), Run and Gun, Pressure Points (+35% Freeze buildup) and Acceleration. At 79 you respec into the Endgame (Early) tree."),
  avoid=[L("Comprar o Morior Invictus antes das resistências", "Buying Morior Invictus before resistances"), L("Trocar Herald e Banner pelas reservas do endgame sem Spirit extra (amuleto de Spirit ou um Morior com o mod de Spirit)", "Swapping Herald and Banner for the endgame reservations without extra Spirit (a Spirit amulet or a Morior with the Spirit mod)")],
 ...
 dict(id="endgame", name=L("Endgame (Early) 79+", "Endgame (Early) 79+"), lv=[79, 90], tag=L("A build do autor, completa", "The author's build, complete"),
  ...
  goal=L("Só a árvore muda (respec para a Endgame (Early)): as skills são as mesmas desde o Ato 1, os Weapon Sets fecham 30 e 31 pontos e as peças sobem. Set 1: spear (Skysliver Runeforged) com Whirling Slash — você anda girando, Desacelera e Cega os inimigos e o giro quebra os Ice Crystals. Set 2: Desolate Crossbow com Glacial Bolt (duas paredes de Ice Crystals), Emergency Reload e Herald of Thunder. Morior Invictus dá Armour e vida por socket; Iron Reflexes converte Evasion em Armour; Scavenged Plating e Arctic Armour seguram o dano de perto. É o setup 'Endgame (Early)' do autor, sem os suportes de Lineage caros.",
         "Only the tree changes (respec into the Endgame (Early)): the skills are the same since Act 1, the Weapon Sets close at 30 and 31 points and the pieces go up. Set 1: spear (Runeforged Skysliver) with Whirling Slash — you move while spinning, Slow and Blind enemies and the spin breaks the Ice Crystals. Set 2: Desolate Crossbow with Glacial Bolt (two walls of Ice Crystals), Emergency Reload and Herald of Thunder. Morior Invictus gives Armour and life per socket; Iron Reflexes converts Evasion to Armour; Scavenged Plating and Arctic Armour hold up close-range damage. It's the author's 'Endgame (Early)' setup, without the expensive Lineage supports."),
  ...
  tree=L("Respec para a árvore Endgame (Early) do autor: 85 pontos + 30 do Weapon Set 1 (spear) + 31 do Set 2 (besta). Só a árvore muda: as skills e os itens seguem os mesmos. Faça quando tiver o Morior Invictus e a Desolate Crossbow, porque a árvore do endgame troca dano de projétil por Armour, Rage e velocidade.", "Respec into the author's Endgame (Early) tree: 85 points + 30 on Weapon Set 1 (spear) + 31 on Set 2 (crossbow). Only the tree changes: skills and items stay the same. Do it once you have Morior Invictus and the Desolate Crossbow, because the endgame tree trades projectile damage for Armour, Rage and speed."),
...
BOX = {
 ...
 "maps": ("2", ["Whirling Slash", "Glacial Bolt"], L("Sem pressa para trocar as reservas: só com Spirit extra (amuleto de Spirit ou um Morior Invictus com o mod de Spirit).", "No rush to swap the reservations: only with extra Spirit (a Spirit amulet or a Morior Invictus with the Spirit mod).")),
...
for pid, note in {"a1": L("Nenhuma reserva ainda: o Herald de Gelo espera o King in the Mists (+30 Spirit, ~10).", "No reservation yet: Ice Herald waits for King in the Mists (+30 Spirit, ~10)."),
                  ...
                  "maps": L("90 de 100 Spirit. Com Spirit extra (amuleto de Spirit, ou um Morior Invictus que rolou +10–14 de Spirit por socket cheio) você troca Herald e Banner pelas reservas do endgame.", "90 of 100 Spirit. With extra Spirit (a Spirit amulet, or a Morior Invictus that rolled +10–14 Spirit per filled socket) you swap Herald and Banner for the endgame reservations."),
                  "endgame": L("Plating 30 + Arctic Armour 30 + Verisium 30 + Berserk 30 = 120: o Spirit extra vem do amuleto e de um Morior Invictus que rolou +10–14 de Spirit por socket cheio.", "Plating 30 + Arctic Armour 30 + Verisium 30 + Berserk 30 = 120: the extra Spirit comes from the amulet and from a Morior Invictus that rolled +10–14 Spirit per filled socket."),
...
MILESTONES = {
 ...
 50: L("Anéis rares melhores. Árvore: Honed Instincts, Vile Wounds e Clean Shot.", "Better rare rings. Tree: Honed Instincts, Vile Wounds and Clean Shot."),
 ...
 65: L("3º Trial: Advanced Thaumaturgy. Morior Invictus fica disponível. A árvore de leveling fecha em 87 pontos.", "3rd Trial: Advanced Thaumaturgy. Morior Invictus becomes available. The leveling tree closes at 87 points."),
 75: L("4º Trial: Motoric Implants (+2 níveis nas skills de Dex).", "4th Trial: Motoric Implants (+2 levels on Dex skills)."),
 79: L("Endgame (Early): respec para a árvore do endgame (as skills não mudam) + Desolate Crossbow, Morior Invictus e as reservas do autor (Arctic Armour, Verisium, Berserk).", "Endgame (Early): respec into the endgame tree (skills don't change) + Desolate Crossbow, Morior Invictus and the author's reservations (Arctic Armour, Verisium, Berserk)."),
...
KEY_PASSIVES = [
 dict(node="Remorseless", type="Notable", text=L("+15% de dano de projétil, +30% de Stun buildup contra inimigos a menos de 2 m, +5 Força.", "+15% projectile damage, +30% Stun buildup against enemies within 2 m, +5 Strength."), when=L("Ato 1 → 78", "Act 1 → 78"), why=L("Primeiro dano de projétil da árvore de leveling do autor.", "The first projectile damage on the author's leveling tree.")),
 dict(node="Ricochet", type="Notable", text=L("+15% de dano de projétil e chance de projétil encadear no terreno.", "+15% projectile damage and a chance for projectiles to chain off terrain."), when=L("Ato 1 → 78", "Act 1 → 78"), why=L("Mais +15% logo nos primeiros 17 pontos.", "Another +15% right in the first 17 points.")),
 dict(node="Heavy Ammunition", type="Notable", text=L("+40% de dano de projétil e de Stun buildup de projétil; −5% de velocidade de ataque.", "+40% projectile damage and projectile Stun buildup; −5% attack speed."), when=L("Ato 2 → 78", "Act 2 → 78"), why=L("O maior dano de projétil do começo; a velocidade volta com Honed Instincts.", "The biggest early projectile damage; speed comes back with Honed Instincts.")),
 dict(node="Careful Aim", type="Notable", text=L("+15% de Accuracy e +20% de dano de projétil.", "+15% Accuracy and +20% projectile damage."), when=L("Ato 2 → 78", "Act 2 → 78"), why=L("Mais dano de projétil e acerto para as balas do Glacial Bolt.", "More projectile damage and accuracy for Glacial Bolt's bolts.")),
 dict(node="Vile Wounds", type="Notable", text=L("+33% de dano com hits contra inimigos afetados por ailments.", "+33% damage with hits against enemies affected by ailments."), when=L("Ato 3 → 78", "Act 3 → 78"), why=L("Tudo o que você acerta está Congelado: o bônus está sempre ligado.", "Everything you hit is Frozen: the bonus is always on.")),
 dict(node="Overwhelm", type="Notable", text=L("+40% de dano com armas de duas mãos (a besta); −5% de velocidade de ataque; +20% de Stun buildup.", "+40% damage with two-handed weapons (the crossbow); −5% attack speed; +20% Stun buildup."), when=L("Ato 3 → 78", "Act 3 → 78"), why=L("A besta é de duas mãos: +40% de dano dela.", "The crossbow is two-handed: +40% damage from it.")),
 dict(node="Rapid Reload", type="Notable", text=L("+40% de velocidade de recarga da besta.", "+40% crossbow reload speed."), when=L("Ato 4 → 78", "Act 4 → 78"), why=L("A Rampart Raptor tem −30% de recarga: este nó compensa e mantém o pente cheio.", "The Rampart Raptor has −30% reload: this node compensates and keeps the clip full.")),
 dict(node="Forces of Nature", type="Notable", text=L("Dano de ataque penetra 15% das resistências elementais do inimigo.", "Attack damage penetrates 15% of enemy elemental resistances."), when=L("Ato 4 → 78", "Act 4 → 78"), why=L("Todo o seu dano é elemental (gelo).", "All your damage is elemental (cold).")),
 dict(node="Pressure Points", type="Notable", text=L("+35% de Stun buildup e +35% de Freeze buildup.", "+35% Stun buildup and +35% Freeze buildup."), when=L("Mapas → 78", "Maps → 78"), why=L("Mais Freeze = mais estilhaços e Vile Wounds sempre ativo.", "More Freeze = more shrapnel and Vile Wounds always on.")),
 dict(node="Iron Reflexes", type="Keystone", text=L("Converte toda a Evasion em Armour.", "Converts all Evasion Rating to Armour."), when=L("Endgame (respec)", "Endgame (respec)"), why=L("O Morior Invictus e as peças de Armour transformam isso em 100 mil de Armour no PoB.", "Morior Invictus and the Armour pieces turn this into 100k Armour in the PoB.")),
 dict(node="Battle Trance", type="Notable", text=L("+8 de Rage máxima.", "+8 maximum Rage."), when=L("Endgame (respec)", "Endgame (respec)"), why=L("A Whirling Slash gera Rage: mais teto de Rage, mais dano.", "Whirling Slash generates Rage: a higher Rage cap, more damage.")),
]
TREE_STAGES = [
 dict(lv="1–15", focus=L("Dano de projétil e movimento", "Projectile damage and movement"), dmg="Permafrost + Whirling Slash", **{"def": L("Vida", "Life")}, spirit="—", dont=L("Pegar Atributo demais", "Taking too much Attribute")),
 dict(lv="16–45", focus=L("Projétil, velocidade e Vile Wounds", "Projectile, speed and Vile Wounds"), dmg="Glacial Bolt + Whirling Slash", **{"def": L("Vida e resistências", "Life and resistances")}, spirit="Herald · Banner", dont=L("Esquecer o Rapid Reload depois", "Forgetting Rapid Reload later")),
 dict(lv="46–78", focus=L("Recarga, penetração e Freeze", "Reload, penetration and Freeze"), dmg="Glacial Bolt + Whirling Slash", **{"def": L("Armour (Plating)", "Armour (Plating)")}, spirit="Herald · Banner · Plating", dont=L("Respec cedo demais", "Respeccing too early")),
 dict(lv="79–100", focus=L("Respec para a árvore do autor com Weapon Sets", "Respec to the author's tree with Weapon Sets"), dmg="Whirling Slash + Glacial Bolt", **{"def": L("Iron Reflexes + Armour", "Iron Reflexes + Armour")}, spirit="Plating · Arctic · Verisium · Berserk", dont=L("Perder o requisito de Dex", "Losing the Dex requirement")),
]

UNIQUES = [
 U("Rampart Raptor", L("Besta", "Crossbow"), L("Arma", "Weapon"), "a1", L("+40–60% de dano físico, +30–40% de velocidade de ataque, −30% de recarga e 100% de chance de não gastar munição se você recarregou há pouco.", "+40–60% physical damage, +30–40% attack speed, −30% reload and a 100% chance not to expend ammo if you've reloaded recently."), L("Do nível 1 ao 78 é a sua besta (Set 2): Tense Crossbow sem requisito de nível (~0,005 Divine); Runeforged no 38 (~0,01), Runemastered no 55 (~2 Divines).", "From level 1 to 78 it's your crossbow (Set 2): Tense Crossbow with no level requirement (~0.005 Divine); Runeforged at 38 (~0.01), Runemastered at 55 (~2 Divines)."), L("Besta rare com dano elemental e velocidade.", "A rare crossbow with elemental damage and speed."), 1),
...
BUY_ORDER = [
 dict(p=1, item=L("Spear branca + Rampart Raptor + Lesser Glacial Rune", "White spear + Rampart Raptor + Lesser Glacial Rune"), phase=L("Nível 1", "Level 1"), cost=L("Barato", "Cheap"), impact=L("A build inteira: Whirling Slash e besta", "The whole build: Whirling Slash and crossbow")),
 ...
 dict(p=7, item="Morior Invictus", phase=L("Mapas", "Maps"), cost=L("Valor", "Value"), impact=L("Armour, vida e atributos por socket (Spirit só se rolar esse mod)", "Armour, life and attributes per socket (Spirit only if it rolls that mod)")),
...
TRICKS = [
 ...
 {"cat": L("Endgame", "Endgame"), "lvl": L("Médio", "Medium"), "title": L("Se o Glacial Bolt parece lento", "If Glacial Bolt feels sluggish"), "body": L("Suba a velocidade de ataque: 10% de ataque escala a recarga como 10% de recarga. No começo, recarga ajuda; com Honed Instincts, Acceleration e Mageblood ela deixa de importar.", "Raise attack speed: 10% attack speed scales reload like 10% reload speed. Early on reload helps; with Honed Instincts, Acceleration and Mageblood it stops mattering.")},
...
TROUBLESHOOT = [
 ...
 (L("Minha recarga está muito lenta", "My reload is too slow"), L("A Rampart Raptor tem −30% de recarga. Suba a velocidade de ataque (Honed Instincts, Adrenaline Rush, Acceleration) e use o Emergency Reload (40).", "The Rampart Raptor has −30% reload. Raise attack speed (Honed Instincts, Adrenaline Rush, Acceleration) and use Emergency Reload (40).")),
 ...
 (L("Não fecho o Spirit", "Spirit doesn't add up"), L("Herald 30, War Banner 30 e Plating 30 = 90 de 100 (quests). No endgame: Plating, Arctic, Verisium e Berserk = 120; o Spirit extra vem do amuleto e de um Morior que rolou +10–14 por socket.", "Herald 30, War Banner 30 and Plating 30 = 90 of 100 (quests). In endgame: Plating, Arctic, Verisium and Berserk = 120; the extra Spirit comes from the amulet and from a Morior that rolled +10–14 per socket.")),
 (L("Estou fraco para o meu nível", "I'm weak for my level"), L("Confira os anéis rares (~30 e ~50), a Rampart Raptor (Runeforged no 38), se o dano vem da BESTA (a spear branca faz pouco dano) e se os nós de dano de projétil da árvore estão pegos (Remorseless, Heavy Ammunition, Careful Aim).", "Check the rare rings (~30 and ~50), the Rampart Raptor (Runeforged at 38), that the damage comes from the CROSSBOW (a white spear does little damage) and that the tree's projectile damage nodes are taken (Remorseless, Heavy Ammunition, Careful Aim).")),
]
ATLAS_CHECK = [
...
FIXES = [
 L("Este plano é uma ADAPTAÇÃO, não a variante Leveling do autor (que não tem Whirling). As skills do endgame (Whirling Slash na spear, Glacial Bolt na besta) entram assim que o jogo permite; a árvore da campanha é a de LEVELING dele porque a do endgame tem 0% de dano de projétil nos primeiros 72 pontos (medido nos nós) contra +251% na de leveling. O autor não valida essa combinação; o respec do 79 leva à árvore Endgame (Early) dele.", "This plan is an ADAPTATION, not the author's Leveling variant (which has no Whirling). The endgame skills (Whirling Slash on the spear, Glacial Bolt on the crossbow) come in as soon as the game allows; the campaign tree is HIS LEVELING one because the endgame tree has 0% projectile damage in the first 72 points (measured on the nodes) against +251% on the leveling one. The author doesn't validate this combination; the 79 respec leads to his Endgame (Early) tree."),
 ...
 L("Até o Glacial Bolt (~24) o dano vem da Permafrost/Fragmentation na besta; a Whirling Slash é o botão de mover e limpar de perto. Uma spear branca faz pouco dano físico: por isso o dano vem da besta e a Skysliver entra no 16.", "Until Glacial Bolt (~24) the damage comes from Permafrost/Fragmentation on the crossbow; Whirling Slash is the move-and-clear-up-close button. A white spear does little physical damage: that's why Skysliver comes in at 16."),
...
UI = dict(
 ...
 treeIntro=L("Árvore real do guia do Phylaris POE: a de LEVELING (87 pontos, dano de projétil primeiro) na campanha e nos mapas; no 79+ você faz respec para a Endgame (Early), com 30 pontos no Weapon Set 1 e 31 no Set 2.", "Real tree from Phylaris POE's guide: the LEVELING one (87 points, projectile damage first) in the campaign and maps; at 79+ you respec into the Endgame (Early), with 30 points on Weapon Set 1 and 31 on Set 2."),
 ...
 respecTip=L("Na troca do 79 (respec), compare com a fase anterior: nós sem contorno verde já eram seus. Weapon Set 1 = spear; Set 2 = besta.", "At the 79 switch (respec), compare with the previous phase: nodes without a green outline were already yours. Weapon Set 1 = spear; Set 2 = crossbow."),
 routeIntro=L("Sete fases do nível 1 ao 100 com as mesmas skills: Whirling Slash na spear (Set 1) e a besta no Set 2 — Permafrost no começo, Glacial Bolt do nível 24. A campanha usa a árvore de leveling do autor (o dano vem dela); no 79 há um respec para a árvore do endgame.", "Seven phases from level 1 to 100 with the same skills: Whirling Slash on the spear (Set 1) and the crossbow in Set 2 — Permafrost at the start, Glacial Bolt from level 24. The campaign uses the author's leveling tree (that's where the damage comes from); at 79 there is a respec into the endgame tree."),
 socketPrio=["Whirling Slash", "Glacial Bolt", "Permafrost Bolts", "Herald of Ice", "War Banner", "Scavenged Plating"],
 permIntro=L("Nada disso volta depois. Spirit paga Herald, Banner e Plating. Os pontos de Weapon Set alimentam o Set 1 (spear) e o Set 2 (besta); no respec do 79 eles fecham em 30 e 31.", "None of this comes back later. Spirit pays for Herald, Banner and Plating. Weapon Set points fuel Set 1 (spear) and Set 2 (crossbow); at the 79 respec they close at 30 and 31."),
...
CHAR = dict(
 ...
 rules=[
  dict(when=dict(lvMin=1, notOwn=["Rampart Raptor"]), lvl="bad", t=L("Falta a Rampart Raptor", "Rampart Raptor missing"), d=L("Tense Crossbow sem requisito de nível, ~0,005 Divine: é a sua besta (Set 2) do nível 1 ao 78.", "Tense Crossbow with no level requirement, ~0.005 Divine: it's your crossbow (Set 2) from level 1 to 78."), tab="gear"),
  ...
  dict(when=dict(lvMin=70, notOwn=["Morior Invictus"]), lvl="tip", t=L("Morior Invictus", "Morior Invictus"), d=L("Armour, vida e atributos por socket (Spirit só se rolar esse mod) (~6 Divines, nível 65).", "Armour, life and attributes per socket (Spirit only if it rolls that mod) (~6 Divines, level 65)."), tab="gear"),
 ],
)
ADAPT_SWAPS = [
...
TREE_RULES = [
 ...
 dict(when=dict(lvMin=79, notOwn=["iron"]), t=L("Iron Reflexes converte Evasion em Armour (árvore do endgame, depois do respec).", "Iron Reflexes converts Evasion to Armour (endgame tree, after the respec)."), node="Iron Reflexes"),
]
...
T("item", "Rampart Raptor", 1, L("Tense Crossbow, nível 0; ~0,005 Divine", "Tense Crossbow, level 0; ~0.005 Divine"), L("Nível 1.", "Level 1."), L("Toda a sua ofensiva de besta do 1 ao 78.", "All your crossbow offence from 1 to 78."), "—", L("Sem ela o Ato 1 fica lento.", "Without it Act 1 is slow."), [L("Runeforged no 38, Runemastered no 55.", "Runeforged at 38, Runemastered at 55.")])
...
T("item", "Morior Invictus", 65, L("Nível 65; ~6 Divines", "Level 65; ~6 Divines"), L("Mapas.", "Maps."), L("Armour, vida e atributos por socket (Spirit só se rolar esse mod).", "Armour, life and attributes per socket (Spirit only if it rolls that mod)."), "—", "—")
...
MECH = dict(
 ...
 sections=[
  dict(type="cards", cards=[
   [L("1. Congelar", "1. Freeze"), L("Permafrost Bolts dispara balas de gelo que se fragmentam e Congelam quase tudo (nível 1). Do nível 24, o Glacial Bolt planta duas paredes de Ice Crystals. Os nós de dano de projétil da árvore (Remorseless, Heavy Ammunition, Careful Aim) dão o dano; Honed Instincts e Acceleration aceleram.", "Permafrost Bolts fires ice bolts that fragment and Freeze almost everything (level 1). From level 24, Glacial Bolt plants two walls of Ice Crystals. The tree's projectile damage nodes (Remorseless, Heavy Ammunition, Careful Aim) give the damage; Honed Instincts and Acceleration speed it up.")],
   ...
   [L("3. Ciclone (Set 1, desde o 1)", "3. Cyclone (Set 1, from level 1)"), L("A Whirling Slash (melee) gira, Desacelera e Cega, gera Rage e, com Biting Frost II (depois Morrigan's Insight), quebra os cristais do Glacial Bolt. Você anda atacando, e as explosões saem sozinhas. No endgame, Dance with Death (árvore do 79+) dá +25% de velocidade de skill com a spear.", "Whirling Slash (melee) spins, Slows and Blinds, generates Rage and, with Biting Frost II (later Morrigan's Insight), breaks Glacial Bolt's crystals. You move while attacking and the explosions happen on their own. In endgame, Dance with Death (79+ tree) gives +25% skill speed with the spear.")],

...
PHASES = [
 ...
 dict(id="maps", name=L("Mapas 65+", "Maps 65+"), lv=[65, 78], tag=L("Herald of Ice, The Taming e Morior Invictus", "Herald of Ice, The Taming and Morior Invictus"),
  ...
  stats=[L("Vida e resistências", "Life and resistances"), L("Velocidade de ataque", "Attack speed"), L("Chance de crítico", "Critical chance")],
  tree=L("Pontos 73–95: Short Shot (+20% de dano de projétil), Killer Instinct (+40% de dano de ataque com a vida cheia), Tenfold Attacks, Flow State e Flow Like Water (velocidade). No 79 você faz o respec para a árvore do PoB: os nós de dano de projétil do começo (26 no total) saem.", "Points 73–95: Short Shot (+20% projectile damage), Killer Instinct (+40% attack damage on Full Life), Tenfold Attacks, Flow State and Flow Like Water (speed). At 79 you respec into the PoB tree: the early projectile damage nodes (26 in total) leave."),

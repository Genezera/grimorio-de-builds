...
SUPWHY = {
 ...
 "Comet": L("Gem de SKILL dentro do Cast on Critical: cai sozinha quando a energia enche.", "SKILL gem inside Cast on Critical: it falls by itself when energy fills."),
 ...
 "Hulking Minions": L("Hellhound maior com mais vida.", "Bigger Hellhound with more life."), "Meat Shield II": L("Hellhound toma menos dano.", "Hellhound takes less damage."), "Elemental Army": L("Resistências elementais para o Hellhound.", "Elemental resistances for the Hellhound."),
...
PHASES = [
 ...
 dict(id="a2", name=L("Ato 2", "Act 2"), lv=[16, 29], tag=L("Mana Tempest + Arcane Surge", "Mana Tempest + Arcane Surge"),
  ...
  gems=[
   ...
   G("Siphon Elements", ["Harmonic Remnants I", "Remnant Potency I"], L("Infusões extras", "Extra infusions"), L("Chance de Infusion Remnant ao dar Freeze/Shock/Ignite. 30 Spirit.", "Chance of an Infusion Remnant on Freeze/Shock/Ignite. 30 Spirit."), "core", 2, SP30),
 ...
 dict(id="a4", name=L("Ato 4 + Interlúdios", "Act 4 + Interludes"), lv=[43, 59], tag=L("Preparar Cast on Critical", "Prepare Cast on Critical"),
  ...
  gems=[
   ...
   G("Spellslinger", ["Flame Wall", "Ignite III", "Spark", "Blind I"], L("Invocação (Dueling Wand)", "Invocation (Dueling Wand)"), L("Vem da Dueling Wand (nível 65). Junta energia ao lançar spells e dispara Flame Wall + Spark.", "Comes from the Dueling Wand (level 65). Gathers energy while casting and triggers Flame Wall + Spark."), "free", since=65),
 ...
 dict(id="max", name=L("Luxo: CoA Comet", "Luxury: CoA Comet"), lv=[92, 100], tag=L("Auto Spark + Cast on Elemental Ailment", "Auto Spark + Cast on Elemental Ailment"),
  ...
  goal=L("A versão do kingkongor que domina o ladder: o Earthbound (Set 2) faz o snapshot de 'dispara Spark ao matar inimigo Shocked' com o Pinnacle of Power, e aí você só anda em Demon Form dando dodge — Cast on Dodge solta Spark, Cast on Elemental Ailment solta Comets, e tudo morre fora da tela. No boss: Ball Lightning com Fire Infusion cria chão em chamas que dispara Comets sem parar. Muito cara (Mageblood com Legacy of Ruby para a resistência máxima a fogo, Reverie, Alpha's Howl, Grip of Kulemak) e precisa de setup a cada mapa.",
         "kingkongor's version that dominates the ladder: Earthbound (Set 2) snapshots 'trigger Spark on killing a Shocked enemy' with Pinnacle of Power, and then you just walk in Demon Form dodging — Cast on Dodge fires Spark, Cast on Elemental Ailment drops Comets, and everything dies off-screen. On bosses: Ball Lightning with a Fire Infusion creates burning ground that triggers Comets nonstop. Very expensive (Mageblood with Legacy of Ruby for max fire resistance, Reverie, Alpha's Howl, Grip of Kulemak) and needs a setup every map."),
  rotation=[L("1. Troque para o Weapon Set 2 (Earthbound)", "1. Swap to Weapon Set 2 (Earthbound)"), L("2. Power Siphon até as Power Charges máximas", "2. Power Siphon up to max Power Charges"), L("3. Lightning Warp (vira Cold Infusion)", "3. Lightning Warp (becomes a Cold Infusion)"), L("4. Pinnacle of Power (volta para o Set 1)", "4. Pinnacle of Power (swaps back to Set 1)"), L("5. Rite of Restoration — se esquecer, você morre", "5. Rite of Restoration — forget it and you die"), L("6. Demon Form e dodge pelo mapa (buff de 2–4 min)", "6. Demon Form and dodge through the map (2–4 min buff)")],
  gems=[
   ...
   G("Power Siphon", ["Rapid Casting III", "Living Lightning II", "Mobility"], L("Power Charges", "Power Charges"), L("Mata inimigos no Cull e dá Power Charge.", "Kills culling-range enemies and grants a Power Charge."), "free"),
   ...
   G("Explosive Transmutation", ["Runic Extraction", "Cooldown Recovery II", "Morrigan's Insight", "Fire Mastery", "Spell Cascade"], L("Remnants explodem", "Remnants explode"), L("30 Spirit.", "30 Spirit."), "core", 3, SP30),
...
SPIRIT_NOTE = {
 "a2": L("Mana Remnants (30) + Siphon Elements (30).", "Mana Remnants (30) + Siphon Elements (30)."),
...
UNIQUES = [
 ...
 U("Blood of the Warrior", "Flask", "Flask", "a4", L("15–30% do dano recebido durante o efeito recuperado como vida; o efeito não sai com a vida cheia.", "15–30% of damage taken during effect recouped as life; the effect isn't removed at full life."), L("Complementa o recoup sem custo.", "Complements recoup at no cost."), L("Flask de vida normal.", "Normal life flask.")),
 ...
 U("Maligaro's Virtuosity", L("Luvas", "Gloves"), L("Armadura", "Armour"), "recoup", L("Chance de crítico aumentada e o crítico não pode ser rerolado.", "Increased crit chance and your crit chance can't be rerolled."), L("Início do endgame, se barata.", "Early endgame, if cheap."), L("Luvas rare de ES.", "Rare ES gloves.")),
 ...
 U("Reverie", "Body Armour", L("Armadura", "Armour"), "max", L("Armour/ES, Chaos Resistance, menos recuperação de flask.", "Armour/ES, Chaos Resistance, less flask recovery."), L("Setup do kingkongor (runemastered para Spirit).", "kingkongor's setup (runemastered for Spirit)."), "Sacrosanctum"),
...
def build(QUESTS_PT):
    ...
    for q in QUESTS_PT:
        ...
        if q["boss"] == "Venom Draught":
            q["reward"] = L("ESCOLHA: Ailment Threshold (Ignatius)", "CHOICE: Ailment Threshold (Ignatius)"); q["prio"] = "Média"
        ...
        if q["boss"] == "Tribal Medicine":
            q["reward"] = L("ESCOLHA: 30% increased Armour, Evasion e ES (Shark Fin)", "CHOICE: 30% increased Armour, Evasion and ES (Shark Fin)"); q["prio"] = "Alta"
        quests.append(q)

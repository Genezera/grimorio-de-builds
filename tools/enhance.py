...
THEME_COLOR = {'silverfist': '#07080a', 'oracle': '#06060c', 'tactician': '#08080a', 'infernalist': '#0a0505', 'acolyte': '#07050b', 'pathfinder': '#060906', 'smith': '#09070a', 'martial': '#05070b', 'shaman': '#080607', 'legionnaire': '#060709', 'whirling': '#05080c', 'twister': '#070a08', 'hyperspeed': '#06070d'}
...
def enhance(template, lang, build):
    css = '\n'.join((SHARED / name).read_text(encoding='utf-8') for name in ['guide.css', 'poe2.css', 'build-now.css', 'fx.css', 'skin.css'])
    ...
    scripts = ['craft-data.js', 'craft-detail.js', 'craft.js', 'weights.js', 'guide.js', 'poe2.js', 'build-now.js', 'fx.js', 'skin.js']

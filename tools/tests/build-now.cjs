...
(async()=>{
 ...
 try{
  ...
  for(const [width,height] of sizes){
   ...
   for(const file of ['silverfist','oracle','tactician','infernalist','acolyte','pathfinder','smith','martial','shaman','legionnaire','whirling','twister','hyperspeed'].flatMap(b=>[b+'/index.html',b+'/en.html'])){

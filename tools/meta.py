...
UNIQUES = [
 ...
 {"n": "Darkness Enthroned", "slot": "Cinto", "cat": "Acessório", "lvl": 62, "p": "t15", "use": 2, "rf": "≈ 0,014 div",
  "why": "2 sockets de Augment com 50–100% mais efeito; a variante define se contam como capacete, body armour, luvas, botas ou escudo. São +2 Idols para a Idolatry (+20% dano dos companions, +4% reservation efficiency).", "how": "Compre a variante Capacete (\"as though it was a Helmet\") e coloque Idol of Ralakesh + Primate Idol. O Ralakesh é limitado a 1: tire do capacete e ponha um Primate Idol lá. Prefira rolls altos de efeito (perto de 100%).", "alt": "Rare vida/resist."},
...
EXTRA_TRICKS = [
 ...
 {"cat": "Spirit", "lvl": "Fácil", "title": "Idols no Sylvan's Effigy",
  "body": "Primate Idol (+40% dano de aliados) e Rabbit Idol (+15% Spirit) custam centavos. No capacete, Idol of Ralakesh dá +8% reservation efficiency de minions; com Darkness Enthroned (variante Capacete), mova o Ralakesh para o cinto, onde o efeito sobe 50–100%."},
...
t15["cheap"] = ["Forgotten Warden base (~0,21 div) com Fox Idol", "Tyranny's Grip Runeforged continua ótima", "Lavianga's Spirits (~0,11 div) + Nascent Hope (~0,11 div)", "Darkness Enthroned (~0,014 div), variante Capacete: Idol of Ralakesh + Primate Idol"]
...
_G["Cinto"].update(value="Rare vida/resist ou Darkness Enthroned variante Capacete (Idol of Ralakesh + Primate Idol)", full="Darkness Enthroned variante Capacete (Idol of Ralakesh + Primate Idol) · Mageblood (luxo)")

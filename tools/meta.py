...
UNIQUES = [
 ...
 {"n": "Darkness Enthroned", "slot": "Cinto", "cat": "Acessório", "lvl": 62, "p": "t15", "use": 2, "rf": "≈ 0,014 div",
  "why": "Sockets de Augment tratados como Capacete/Escudo/Botas/Luvas com 50–99% mais efeito: mais Idols para a Idolatry.", "how": "", "alt": "Rare vida/resist."},
...
t15["cheap"] = ["Forgotten Warden base (~0,21 div) com Fox Idol", "Tyranny's Grip Runeforged continua ótima", "Lavianga's Spirits (~0,11 div) + Nascent Hope (~0,11 div)", "Darkness Enthroned (~0,014 div) para Idols extras"]
...
_G["Cinto"].update(value="Rare vida/resist ou Darkness Enthroned (Idols)", full="Darkness Enthroned · Mageblood (luxo)")

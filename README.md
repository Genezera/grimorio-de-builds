...
| `whirling/index.html` · `whirling/en.html` | Mercenary · Gemling Legionnaire — Whirling Slash + Glacial Bolt (besta de gelo; Permafrost Bolts + Fragmentation Rounds do nível 1 ao 78) — guia do Phylaris POE (Mobalytics) |

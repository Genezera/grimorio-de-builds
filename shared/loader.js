...
(() => {
  ...
  const BUILDS = {
    ...
    shaman: ['sh', 'Tempestade de Mana', 'Druid · Shaman'], legionnaire: ['lg', 'Trovão Cortante', 'Mercenary · Gemling Legionnaire'],
  };
  const PAL = { silverfist: ['#07080a', '#5fe3c1', '#c3a066', '#ecd6a3'], oracle: ['#06060c', '#a58dff', '#b7bfd9', '#eef1fb'], tactician: ['#08080a', '#ff8a3d', '#c9a46a', '#f0dcb0'],
    ...
    smith: ['#09070a', '#ff6a13', '#d08a47', '#f5cf9f'], martial: ['#05070b', '#4cc3ff', '#e0b25c', '#f7deaa'], shaman: ['#080607', '#2fd9c0', '#d1a75f', '#f6dcab'], legionnaire: ['#060709', '#ffd23f', '#b9a27a', '#f1e2bd'],

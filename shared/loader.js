...
(() => {
  ...
  const BUILDS = {
    ...
    shaman: ['sh', 'Mana Storm', 'Druid · Shaman'], legionnaire: ['lg', 'Cleaving Thunder', 'Mercenary · Gemling Legionnaire'], whirling: ['gw', 'Frost Cyclone', 'Mercenary · Gemling Legionnaire'], twister: ['tw', 'Spear Twister', 'Mercenary · Gemling Legionnaire'], hyperspeed: ['hs', 'Hyper Speed Monk', 'Monk · Martial Artist'],
  };

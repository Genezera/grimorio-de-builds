...
window.skFx = kind => {
  ...
  if (kind === 'lightning') {
    ...
    const n = kind === 'void' ? 3 : kind === 'stars' ? 14 : 9;
...
window.SK_FX = { silverfist: 'spirit', oracle: 'stars', tactician: 'fire', infernalist: 'hell', acolyte: 'void', pathfinder: 'toxic', smith: 'forge', martial: 'lightning', shaman: 'lightning', legionnaire: 'lightning',
                 sf: 'spirit', or: 'stars', ta: 'fire', in: 'hell', ac: 'void', pf: 'toxic', sk: 'forge', ma: 'lightning', sh: 'lightning', lg: 'lightning' };
